...
<asp:Content runat="server" ID="FeaturedContent" ContentPlaceHolderID="FeaturedContent">
    ...
    <section class="featured">
        <div class="content-wrapper">
            ...
            <p>
                This page is for adults ages 18 and up that are interested in learning about the IT field, what jobs are offered, what the education requirements are for that position, what areas in Louisiana currently have job openings, and the supply and demand for that position.
            </p>
        </div>
    </section>
</asp:Content>
